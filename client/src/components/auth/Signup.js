...
import bgImg from "../../img/landingpage-background.jpg";
...
function Signup(props) {
	...
	return (
		...
		// </div>
		<div className="auth ">
			<img src={bgImg} className="background-img" />
			<Container fluid>
				<Row className="pt-5 justify-content-center align-items-center">
					<Link to="/" className="d-flex align-items-end logo-link">
						<img src={logo} width="30" height="30" className="svg-filter" />
						<h3 className="d-inline-block m-0 text-light">odoie</h3>
					</Link>
				</Row>
